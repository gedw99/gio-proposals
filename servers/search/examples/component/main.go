...
import (
	...
	"github.com/gedw99/gio-proposals/servers/search/examples/simple/about"
...
/*
func LayoutAboutPageFolder(gtx C) D {
	// call in.
...
type Page struct {
	...
	// gedw99: needed to pass in theme pointer to all pages.
	layout func(layout.Context, th material.Theme) layout.Dimensions
	component.NavItem
